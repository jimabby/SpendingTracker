...
import { clearState } from '../storage/storage';
...
export default function SettingsScreen() {
  ...
  const { currency, categories } = state;
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      <View style={styles.section}>
        ...
        <View style={[styles.comingSoon, { borderTopWidth: 1, borderTopColor: '#F0F0F5' }]}>
          <Ionicons name="sparkles-outline" size={20} color="#B2BEC3" />
          <Text style={styles.comingSoonText}>AI Assistant</Text>
          <View style={styles.badge}><Text style={styles.badgeText}>Soon</Text></View>
        </View>
      </View>

      <Text style={styles.version}>Spending Tracker v1.0</Text>
